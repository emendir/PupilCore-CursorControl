# CursorControl.Xlib.protocol.rq -- structure primitives for request, events and errors
#
...
from CursorControl.six import PY3, binary_type, byte2int, indexbytes, iterbytes
...
class Struct(object):
    ...
    def parse_binary(self, data, display, rawdict = 0):
        ...
        DISPLAY should be a CursorControl.Xlib.protocol.display.Display object if
