# CursorControl.Xlib.XK -- X keysym defs
#
...
# definition modules in the CursorControl.Xlib/keysymdef directory.

from CursorControl.Xlib.X import NoSymbol
...
def load_keysym_group(group):
    ...
    defined in module 'CursorControl.Xlib.keysymdef.group-name' into this XK module.'''
    if '.' in group:
    ...
    mod = __import__('CursorControl.Xlib.keysymdef.%s' % group, G, locals(), [group])
...
def _load_keysyms_into_XK(mod):
    '''keysym definition modules need no longer call CursorControl.Xlib.XK._load_keysyms_into_XK().
