# CursorControl.Xlib.display -- high level display object
#
...
from CursorControl.six import create_unbound_method

# CursorControl.Xlib modules
from . import error
from . import ext
from . import X

# CursorControl.Xlib.protocol modules
from .protocol import display as protocol_display
from .protocol import request, event, rq

# CursorControl.Xlib.xobjects modules
...
class _BaseDisplay(protocol_display.Display):
    ...
    # dealing with some ICCCM properties not defined in CursorControl.Xlib.Xatom
...
class Display(object):
    def __init__(self, display = None):
        ...
        for extname, modname in ext.__extensions__:
            if extname in exts:
                ...
                __import__('CursorControl.Xlib.ext.' + modname)
    ...
    def lookup_string(self, keysym):
        ...
        import CursorControl.Xlib.XK
        return CursorControl.Xlib.XK.keysym_to_string(keysym)
