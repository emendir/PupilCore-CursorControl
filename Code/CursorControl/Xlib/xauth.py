# CursorControl.Xlib.xauth -- ~/.Xauthority access
#
...
from CursorControl.Xlib import X, error
...
class Xauthority(object):
    def __init__(self, filename = None):
        ...
        try:
            ...
            print("CursorControl.Xlib.xauth: warning, failed to parse part of xauthority file {0}, aborting all further parsing".format(filename))

        if len(self.entries) == 0:
            print("CursorControl.Xlib.xauth: warning, no xauthority details available")
