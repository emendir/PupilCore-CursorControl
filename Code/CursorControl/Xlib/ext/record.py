# CursorControl.Xlib.ext.record -- RECORD extension module
#
...
from CursorControl.Xlib.protocol import rq
...
class EnableContext(rq.ReplyRequest):
    ...
    def _parse_response(self, data):
        ...
        if r.category == StartOfData:
            ...
            # CursorControl.Xlib.protocol.display.Display.parse_request_response()
